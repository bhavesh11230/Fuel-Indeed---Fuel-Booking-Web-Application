            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="ViewTodaysAssign.jsp"
                                aria-expanded="false">
                                <i class="fa fa-table" aria-hidden="true"></i>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="ViewDelivered.jsp"
                                aria-expanded="false">
                                <i class="fa fa-table" aria-hidden="true"></i>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="ViewRejected.jsp"
                                aria-expanded="false">
                                <i class="fa fa-table" aria-hidden="true"></i>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="changestationpassword.html"
                                aria-expanded="false">
                                <i class="fa fa-table" aria-hidden="true"></i>
                			...
                			Connection con = ConnectDB.dbCon();
               				 try {
               					String femail = FuelStationGetSet.getFemail();
               					 PreparedStatement ps = con.prepareStatement("select fid,fname,fpetrolqty,fpetrolrate,fdiselqty,fdiselrate from fuelstation where femail=?");
