            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="ViewAssignBookings.jsp"
                                aria-expanded="false">
                                <i class="fa fa-table" aria-hidden="true"></i>
            ...
            <div class="container-fluid">
                ...
                <table class="table table-hover"> 
                        ...
                        <tr>
                            ...
                            <td><%= rs.getFloat(6) %></td>
                            <td><%= rs.getFloat(7) %></td>
                            <td><a href="AssignedDelivery.jsp?fid=<%= rs.getInt(3) %>">Assigned</a><br><a href="RejectDelivery.jsp?uid=<%= rs.getInt(2) %>">Reject</a></td>
                        </tr>
            <%      }
                } catch(Exception e) {
                    e.printStackTrace();
