            ...
            <div class="container-fluid">
                ...
                <table class="table table-hover"> 
                			...
                			Connection con = ConnectDB.dbCon();
               				 try {
               					...
               					String fpincode = request.getParameter("fpincode");
               					 PreparedStatement ps = con.prepareStatement("select fid,fname,faddress,fpetrolqty,fpetrolrate,fdiselqty,fdiselrate from fuelstation where fpincode=?");
               					 ps.setString(1, fpincode);
                        ...
                        <tr>
                            ...
                            <td><%= rs.getFloat(6) %></td>
                            <td><%= rs.getFloat(7) %></td>
                            <td><a href="BookFuel.jsp?fid=<%=rs.getInt(1)%>">Book</a></td>
                        </tr>
            <%      }
                } catch(Exception e) {
                    e.printStackTrace();
