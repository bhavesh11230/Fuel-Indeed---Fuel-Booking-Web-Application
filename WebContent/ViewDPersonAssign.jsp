            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="ViewAssignedBookings.jsp"
                                aria-expanded="false">
                                <i class="fa fa-user" aria-hidden="true"></i>
                ...
                <table class="table table-hover"> 
                			...
                			Connection con = ConnectDB.dbCon();
               				 try {
               					...
               					int did = DPersonEmailGetSet.getId();
               					String status = "assigned";
               					 PreparedStatement ps = con.prepareStatement("select * from bookings where status=? and did=?");
                        ...
                        <tr>
                            ...
                            <td><a href="codeenter.html">Enter Code</a></td>
                        </tr>
            <%      }
                } catch(Exception e) {
                    e.printStackTrace();
